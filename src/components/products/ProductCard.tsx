    ...
    >
      ...
      <div className="relative aspect-[4/5] w-full overflow-hidden bg-[#F2EFE9] cursor-pointer">
        ...
        <button
          ...
          className="absolute top-3 right-3 z-10 w-9 h-9 rounded-full bg-white/90 backdrop-blur-md flex items-center justify-center text-neutral-600 hover:text-rose-500 shadow-sm transition-transform active:scale-90 cursor-pointer"
        ...
        <div className="absolute bottom-3 inset-x-3 z-10 transition-all duration-300">
          <button
            ...
            className={`w-full py-2.5 px-4 rounded-xl text-xs font-semibold tracking-wide flex items-center justify-center gap-1.5 shadow-md backdrop-blur-md transition-all cursor-pointer ${
              justAdded
