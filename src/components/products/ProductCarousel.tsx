        ...
        <div className="flex flex-col sm:flex-row sm:items-end justify-between mb-6 gap-4">
          ...
          <div className="flex items-center gap-3">
            {onViewAll && (
              <button
                onClick={onViewAll}
                className="text-xs sm:text-sm font-semibold text-neutral-900 hover:text-neutral-600 flex items-center gap-1 group font-mono transition-colors cursor-pointer"
              >
            ...
            <div className="flex items-center gap-1.5 ml-2">
              <button
                ...
                className={`w-9 h-9 rounded-full border border-neutral-300 flex items-center justify-center transition-all cursor-pointer ${
                  canScrollLeft
